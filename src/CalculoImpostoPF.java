...
public class CalculoImpostoPF {
	...
	public static void main(String[] args) {
		//imprimirTelaInicial();
			...
			private static double calcularAliquota(double salarioBruto) {
			...
			private static double calcularINSS(double salario, double aliquota) {
				return salario * (aliquota/100);
			}
			private static double calcularSalarioLiquido(double irRetido, double inssRetido, double salarioBruto) {
